...
<a href="index.php"><section class="d-flex justify-content-center align-items-center mb-3">
                <img src="imagens/Logo_white.png" class="img-fluid" style="position: absolute; height: 42vh;" alt="foto de capa">
                <img src="imagens/capapa.png" class="img-fluid">
            </section></a>
        <div class="container-fluid mb-2">
            <div class="d-flex">
                <a href="index.php"><img src="imagens/Logo_black.png" class="justify-content-start mr-5" style="height: 50px;"></a>
